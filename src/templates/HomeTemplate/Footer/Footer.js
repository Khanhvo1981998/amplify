        ...
        <footer class="text-center lg:text-left bg-gray-100 text-gray-600">
            <div class="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
                ...
                <div class="flex justify-center">
                    <a href="https://www.facebook.com/" class="mr-6 text-gray-600">
            ...
            <div class="mx-6 py-10 text-center md:text-left">
                ...
                ">
                        ...
                        <p>
                            Thank you for trusting and accompanying us
                        </p>
                    </div>
                    <div class=" text-left">
            ...
            <div class="text-center p-6 bg-gray-200">
                <span>© 2022 Copyright by </span>
                <a class="text-gray-600 font-semibold" href="https://tailwind-elements.com/">khanhvd</a>
            </div>
        </footer>
    )
}
